...
public class Filters {
	...
	public String limit;
	@JsonIgnore
	public final Map<String, Object> additionalProperties = new HashMap<String, Object>();
	...
	public ImmutableMap<String, String> GetFilterMap(){
		Builder<String, String> myMapBuilder = ImmutableMap.builder();
		...
		for(Field field : fields) {
			...
			if (pair != null && pair.getValue() != null && pair.getKey() != null && !pair.getKey().equals(""))
